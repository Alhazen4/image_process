...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.blackwhite_label = QLabel('')
        self.blackwhite_label.setText("Negative")
        ...
        self.horizontalLayout.addWidget(self.blackwhite_label)
        ...
        self.blwh = QLabel('')
        self.blwh.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.horizontalLayout.addWidget(self.blwh)
    ...
    def changeBlwh(self, img, value):
        img = cv2.threshold(img, value, 255, cv2.THRESH_BINARY)[1]
        return img
    ...
    def update(self):
        ...
        img = self.changeBlwh(img, self.blackwhite_value_now)
        ...
        self.blwh.setText('Negative: %d' % self.blackwhite_value_now)
